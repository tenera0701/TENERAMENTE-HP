...
- LINE：友だち登録が済んだ顧客への継続的な追客に向きます。画像や物件のURLを送りやすく、やり取りが1つのトークに残るため、担当が代わっても経緯を追えます
- SMS：電話番号しか分かっていない段階や、確実に見てほしい連絡に向きます。来店前日のリマインド、折り返しの依頼など、短い一往復で完結する用件が中心です
- 使い分けの基準：登録済みならLINE、未登録ならSMS。SMSで送るのは「日時」「場所」「短い依頼」に絞り、長い提案はLINEかメールに回します
